    ...
    return (
      <>
        ...
        <Box alignSelf="center" direction="row-responsive">
          <Text size="large">
            <Braille gap="xlarge" />
            <Braille gap="xlarge" /> only repeat yourself, 
            <br></br>
            <br></br>
            <Braille gap="xlarge" /> with arts and causes, we unite.
            <br></br>
            <br></br>
            <Braille gap="xlarge" /> populism is a tool of non-creatives, 
            <br></br>
            <br></br>
            <Braille gap="xlarge" /> populism is a tool of non-creatives, 
            <br></br>
          ...
          <Text size="large">
            ...
            <br></br>
            <br></br>
            <Braille gap="xlarge" /> build tools, solutions together
            <br></br>
            <br></br>
            ...
            <br></br>
            <Braille gap="xlarge" /> again and again.
